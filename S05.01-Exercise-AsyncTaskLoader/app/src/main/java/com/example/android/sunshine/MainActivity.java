...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapterOnClickHandler,LoaderCallbacks<String[]> {
    ...
    private static final int FORECAST_LOAD_ID = 22;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportLoaderManager().initLoader(FORECAST_LOAD_ID,null,MainActivity.this);
    }
    ...
    public Loader<String[]> onCreateLoader(int id, final Bundle args){
        ...
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                URL weatherURL = NetworkUtils.buildUrl(query);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            getSupportLoaderManager().restartLoader(FORECAST_LOAD_ID,null,this);
            return true;
        }

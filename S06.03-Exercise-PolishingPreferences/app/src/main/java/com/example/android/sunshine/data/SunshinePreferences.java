...
public class SunshinePreferences {
    ...
    public static String getPreferredWeatherLocation(Context context) {
        ...
        return preferences.getString(locationKey,location);
    }
    ...
    public static boolean isMetric(Context context) {
        ...
        String initUnits = context.getString(R.string.pref_units_metric);
        String prefUnits = preference.getString(unitKey,initUnits);
